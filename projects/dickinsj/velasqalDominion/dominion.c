...
void executeBaron(int choice1, struct gameState *state, int currentPlayer){
...
void executeMinion(int choice1, int choice2, int handPos, struct gameState *state, int currentPlayer){
    int i;
    int j;
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case baron:
        executeBaron(choice1, state, currentPlayer);
        return 0;
    ...
    case minion:
        executeMinion(choice1, choice2, handPos, state, currentPlayer);
        return 0;
    ...
    case tribute:
        executeTribute(currentPlayer, nextPlayer, state);
        return 0;
